...
lcd.print("*--*---*----*---*--*");
lcd.setCursor(0, 1);
lcd.print("    Bao cao nhom    ");
lcd.setCursor(0, 2);
lcd.print("Smart garden system ");
lcd.setCursor(0, 3);
lcd.print("*--*---*----*---*--*");
delay(3500);
lcd.setCursor(0, 1);
      ...
      if (client.available()) {  
        ...
        if (c == '\n') {                  
          if (currentLine.length() == 0) {
            ...
            client.println("<head>");
            client.println("<title>Hệ thống nhúng 2019</title>");
            ...
            client.println("<p><b>Trường đại học SPKT</b></p>");
            client.println("<p><b>Class:186410SP2 </b></p>");
            client.println("<p><b>Thành viên</b>: Tòng, Loan</p>");
            client.println("<h1><font color=#dd0000>Sensor value</font></h1>");
            client.println("<div class=\"row voffset\">");
            client.println("<div class=\"col-md-3\"><font color=#00cc33>Nhiệt độ</font> : </div><div class=\"col-md-3\">" + String(t) + String("&degC") +"</div>");
            client.println("<div class=\"col-md-3\"><font color=#00cc33>Độ ẩm không khí</font>: </div><div class=\"col-md-3\">" + String(h)+ String("%") +"</div>");
            client.println("<div class=\"col-md-3\"><font color=#00cc33>Ánh sáng </font>: </div><div class=\"col-md-3\">" + String(asvalue)+ String("%")+ "</div>");
            client.println("<div class=\"col-md-3\"><font color=#00cc33>Độ ẩm đất</font>: </div><div class=\"col-md-3\">" + String(datvalue)+ String("%")+ "</div>");
